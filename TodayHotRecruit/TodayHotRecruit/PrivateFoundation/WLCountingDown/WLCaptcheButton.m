...
- (UILabel *)overlayLabel {
    if (!_overlayLabel) {
        ...
        _overlayLabel.font            = font(PXGet375Width(20));//self.titleLabel.font;
...
- (void)shouldCountDown {
    ...
    [[WLButtonCountdownManager defaultManager] scheduledCountDownWithKey:self.identifyKey timeInterval:59 countingDown:^(NSTimeInterval leftTimeInterval) {
        ...
        self.layer.borderColor = CommonBlue.CGColor;
